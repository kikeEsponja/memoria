...
let nivel2 = document.getElementById('nivel_2');
nivel2.addEventListener('click', ()=>{
    window.location.href = './memoria2.html';
});
...
function ganador(){
    ...
    //NIVEL 4
    let nivel4 = document.createElement('button');
    ...
    //NIVEL 4
    nivel4.textContent = 'Nivel 4';
    nivel4.classList.add('botones');

    nivel4.addEventListener('click', () =>{
        window.location.href = '../vistas/memoria4.html';
    });
