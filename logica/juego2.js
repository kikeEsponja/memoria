...
/* ****************************** BOTÓN PARA IR A NIVEL ANTERIOR (no está presente en el primer nivel)*************************/
...
function ganador(){
    ...
    nivel3.classList.add('botones');

    nivel3.addEventListener('click', () =>{
        window.location.href = '../vistas/memoria3.html';
    });
