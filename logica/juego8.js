...
let nivel7 = document.getElementById('nivel_7');
nivel7.addEventListener('click', ()=>{
    window.location.href = './memoria7.html';
});
...
function ganador(){
    ...
    //NIVEL 9
    let nivel9 = document.createElement('button');
    ...
    //NIVEL 9
    nivel9.textContent = 'Nivel 9';
    nivel9.classList.add('botones');

    nivel9.addEventListener('click', () =>{
        window.location.href = '../vistas/memoria9.html';
    });
