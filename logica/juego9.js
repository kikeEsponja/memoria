...
let nivel8 = document.getElementById('nivel_8');
nivel8.addEventListener('click', ()=>{
    window.location.href = './memoria8.html';
});
...
function ganador(){
    ...
    //NIVEL 10
    let nivel10 = document.createElement('button');
    ...
    //NIVEL 10
    nivel10.textContent = 'Nivel 10';
    nivel10.classList.add('botones');

    nivel10.addEventListener('click', () =>{
        window.location.href = '../vistas/memoria10.html';
    });
    ...
    contenedor.appendChild(nivel10);
