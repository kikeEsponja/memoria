...
let nivel3 = document.getElementById('nivel_3');
nivel3.addEventListener('click', ()=>{
    window.location.href = './memoria3.html';
});
...
function ganador(){
    ...
    //NIVEL 5
    let nivel5 = document.createElement('button');
    ...
    //NIVEL 5
    nivel5.textContent = 'Nivel 5';
    nivel5.classList.add('botones');

    nivel5.addEventListener('click', () =>{
        window.location.href = '../vistas/memoria5.html';
    });
