...
let nivel5 = document.getElementById('nivel_5');
nivel5.addEventListener('click', ()=>{
    window.location.href = './memoria5.html';
});
...
function ganador(){
    ...
    //NIVEL 7
    let nivel7 = document.createElement('button');
    ...
    //NIVEL 7
    nivel7.textContent = 'Nivel 7';
    nivel7.classList.add('botones');

    nivel7.addEventListener('click', () =>{
        window.location.href = '../vistas/memoria7.html';
    });
