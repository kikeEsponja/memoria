...
let nivel4 = document.getElementById('nivel_4');
nivel4.addEventListener('click', ()=>{
    window.location.href = './memoria4.html';
});
...
function ganador(){
    ...
    //NIVEL 6
    let nivel6 = document.createElement('button');
    ...
    //NIVEL 6
    nivel6.textContent = 'Nivel 6';
    nivel6.classList.add('botones');

    nivel6.addEventListener('click', () =>{
        window.location.href = '../vistas/memoria6.html';
    });
